...
import Shop from "../cardsimg/shop.jpg";
...
import Lahore2 from "../mapimg/lahore2.jpeg";
            ...
            <div className="container-fluid mt-5 mb-5">
                <div className="row" >
                    <div className="col-md-7">
                        <div>
                            <img src={Shop} style={{width:"800px"}} />
                        </div>
                        <div className="mt-3 p-4" style={{border:"1px solid black", width:"800px"}}>
                            <h3 className="ml-3 mt-1">Details</h3>
                            <p className="mt-3 para">Make<span>Shop</span><span>Year</span><span>2011</span></p>
                            ...
                            <p className="">Pop-Up Shop<br/>Shop is a multi super store<br/>Shop is completely fine condition<br/>Shop have a complete File and papers<br/>Only interested person can contact me<span></span></p>
                        </div>
                    </div>
                    <div className="col-md-4" style={{border:"1px solid black",height:"150px",marginLeft:"70px"}}>
                        <div>
                            <h2 className="mt-3">Rs: 3400000<span style={{float:"right",fontSize:"30px"}}><ShareTwoToneIcon style={{marginRight:"30px"}}/><FavoriteBorderIcon/></span></h2>
                            <p>Pop-Up Shop 2011 good condition</p>
                            <p>Lahore, Punjab, Pakistan<span style={{float:"right"}}>15days ago</span></p>
                        </div>
                        ...
                        <div className="mt-5 p-2" style={{border:"1px solid black",marginTop:"20px",height:"350px",marginLeft:"-15px",width:"450px"}}>
                            ...
                            <div style={{width:"500px"}}><img src={Lahore2} style={{width:"400px",marginLeft:"15px",height:"270px"}}/></div>
                            <div className="mt-4">
