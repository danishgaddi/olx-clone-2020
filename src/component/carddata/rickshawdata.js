...
import Rickshaw from "../cardsimg/rikshaw.jpg";
...
class Rickshawdata extends Component {
    render() {
        return (
            <React.Fragment>
                <Header/>
            <div className="container-fluid mt-5 mb-5">
                <div className="row" >
                    <div className="col-md-7">
                        <div>
                            <img src={Rickshaw} style={{width:"800px"}} />
                        </div>
                        <div className="mt-3 p-4" style={{border:"1px solid black", width:"800px"}}>
                            <h3 className="ml-3 mt-1">Details</h3>
                            <p className="mt-3 para">Make<span>Sazgar</span><span>Year</span><span>2019</span></p>
                            ...
                            <p className="">Sazgar 3 star<br/>Cng and Petrol system<br/>Rickshaw is completely fine condition<br/>Rickshaw have a complete File and papers<br/>Only interested person can contact me<span></span></p>
                        </div>
                    </div>
                    <div className="col-md-4" style={{border:"1px solid black",height:"150px",marginLeft:"70px"}}>
                        <div>
                            <h2 className="mt-3">Rs: 105000<span style={{float:"right",fontSize:"30px"}}><ShareTwoToneIcon style={{marginRight:"30px"}}/><FavoriteBorderIcon/></span></h2>
                            <p>Sazgar 3 star Cng Rickshaw 2018-2019 good condition</p>
