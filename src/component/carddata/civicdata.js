...
import Civic from "../cardsimg/hondacivic.jpg";
...
class Civicdata extends Component {
    render() {
        return (
            <React.Fragment>
                <Header/>
            <div className="container-fluid mt-5 mb-5">
                <div className="row" >
                    <div className="col-md-7">
                        <div>
                            <img src={Civic} style={{width:"800px"}} />
                        </div>
                        <div className="mt-3 p-4" style={{border:"1px solid black", width:"800px"}}>
                            ...
                            <p className="">Honda Civic 2020<br/>Civic now in UG<br/>Civic is completely fine condition<br/>Civic have a complete File and papers<br/>Only interested person can contact me<span></span></p>
                        </div>
                    </div>
                    <div className="col-md-4" style={{border:"1px solid black",height:"150px",marginLeft:"70px"}}>
                        <div>
                            <h2 className="mt-3">Rs: 3500000<span style={{float:"right",fontSize:"30px"}}><ShareTwoToneIcon style={{marginRight:"30px"}}/><FavoriteBorderIcon/></span></h2>
                            <p>Honda Civic 2019-2020 good condition</p>
                            <p>Multan, Punjab, Pakistan<span style={{float:"right"}}>21days ago</span></p>
                        </div>
