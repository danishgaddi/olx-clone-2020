...
import Bike from "../cardsimg/bikes.jpg";
...
import karachi from "../mapimg/karachi.jpg";
            ...
            <div className="container-fluid mt-5 mb-5">
                <div className="row" >
                    <div className="col-md-7">
                        <div>
                            <img src={Bike} style={{width:"800px"}} />
                        </div>
                        <div className="mt-3 p-4" style={{border:"1px solid black", width:"800px"}}>
                            <h3 className="ml-3 mt-1">Details</h3>
                            <p className="mt-3 para">Make<span>Honda</span><span>Year</span><span>2018</span></p>
                            ...
                            <p className="">Honda CD 70<br/>Condition 08/10<br/>Bike is completely fine condition<br/>Bike have a complete File and papers<br/>Only interested person can contact me<span></span></p>
                        </div>
                    </div>
                    <div className="col-md-4" style={{border:"1px solid black",height:"150px",marginLeft:"70px"}}>
                        <div>
                            ...
                            <p>Honda CD 70 2017-2018 good condition</p>
                            <p>Karachi, Sindh, Pakistan<span style={{float:"right"}}>2days ago</span></p>
                        </div>
                        ...
                        <div className="mt-5 p-2" style={{border:"1px solid black",marginTop:"20px",height:"350px",marginLeft:"-15px",width:"450px"}}>
                            ...
                            <div style={{width:"500px"}}><img src={karachi} style={{width:"400px",marginLeft:"15px",height:"270px"}}/></div>
                            <div className="mt-4">
                                <h6>AD ID 1234567890 <span style={{float:"right"}}>Report THIS AD</span></h6>
                            </div>
                            <div style={{textAlign:"center",marginTop:"60px",fontWeight:"bold"}}>
