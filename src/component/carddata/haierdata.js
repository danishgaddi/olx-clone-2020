...
import Haier from "../cardsimg/wash.jpg";
...
import karachi2 from "../mapimg/karachi2.jpg";
// import logo from "../../olxlogo/olx.png";
class Haierdata extends Component {
    render() {
        return (
            <React.Fragment>
                <Header/>
            <div className="container-fluid mt-5 mb-5">
                <div className="row" >
                    <div className="col-md-7">
                        <div>
                            <img src={Haier} style={{width:"800px"}} />
                        </div>
                        <div className="mt-3 p-4" style={{border:"1px solid black", width:"800px"}}>
                            <h3 className="ml-3 mt-1">Details</h3>
                            <p className="mt-3 para">Make<span>Electronics</span><span>Year</span><span>2019</span></p>
                            ...
                            <p className="">Haier DC inverter split<br/>Split have a solar system <br/>Split is completely fine condition<br/>Split have a 1.5 ton with outer unit<br/>Only interested person can contact me<span></span></p>
                        </div>
                    </div>
                    <div className="col-md-4" style={{border:"1px solid black",height:"150px",marginLeft:"70px"}}>
                        <div>
                            <h2 className="mt-3">Rs: 45000<span style={{float:"right",fontSize:"30px"}}><ShareTwoToneIcon style={{marginRight:"30px"}}/><FavoriteBorderIcon/></span></h2>
                            <p>Haier DC inverter 2019 good condition</p>
                            <p>Sukkar, Sindh, Pakistan<span  style={{float:"right"}}>2days ago</span></p>
                        </div>
                        ...
                        <div className="p-2" style={{border:"1px solid black",marginTop:"10px",height:"350px",marginLeft:"-15px",width:"450px"}}>
                            <h4 className="mt-3 mx-2">Posted In</h4>
                            <div style={{width:"500px"}}><img src={karachi2} style={{width:"400px",marginLeft:"15px",height:"270px"}}/></div>
                            <div className="mt-4">
