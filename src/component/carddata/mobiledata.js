...
import Mobile from "../cardsimg/mobile.jpg";
                ...
                <div className="row" >
                    <div className="col-md-7">
                        ...
                        <div className="mt-3 p-4" style={{border:"1px solid black", width:"800px"}}>
                            ...
                            <p className="mt-3 para">Make<span>Iphone</span><span>Year</span><span>2020</span></p>
                            ...
                            <p className="">Iphone 12pro max<br/>Iphone have a new hotest models<br/>Iphone is completely fine condition<br/>Only interested person can contact me<span></span></p>
                        </div>
                    </div>
                    <div className="col-md-4" style={{border:"1px solid black",height:"150px",marginLeft:"70px"}}>
                        <div>
                            <h2 className="mt-3">Rs: 215000<span style={{float:"right",fontSize:"30px"}}><ShareTwoToneIcon style={{marginRight:"30px"}}/><FavoriteBorderIcon/></span></h2>
                            <p>Iphone 12 pro max 2020 good condition</p>
