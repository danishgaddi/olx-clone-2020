...
import Table from "../cardsimg/table.jpg";
...
import Quetta from "../mapimg/quetta.gif";
            ...
            <div className="container-fluid mt-5 mb-5">
                <div className="row" >
                    <div className="col-md-7">
                        <div>
                            <img src={Table} style={{width:"800px"}} />
                        </div>
                        <div className="mt-3 p-4" style={{border:"1px solid black", width:"800px"}}>
                            <h3 className="ml-3 mt-1">Details</h3>
                            <p className="mt-3 para">Make<span>Furniture</span><span>Year</span><span>2020</span></p>
                            ...
                            <p className="">Wooden Pecker Table and chairs<br/>Tables and chairs have Home and office use <br/>Furniture is completely fine condition<br/>Only interested person can contact me<span></span></p>
                        </div>
                    </div>
                    <div className="col-md-4" style={{border:"1px solid black",height:"150px",marginLeft:"70px"}}>
                        <div>
                            <h2 className="mt-3">Rs: 35000<span style={{float:"right",fontSize:"30px"}}><ShareTwoToneIcon style={{marginRight:"30px"}}/><FavoriteBorderIcon/></span></h2>
                            <p>Wooden Pecker 2020 Tables and chairs good condition</p>
                            <p>Quetta, Balochistan, Pakistan<span style={{float:"right"}}>21days ago</span></p>
                        </div>
                        ...
                        <div className="mt-5 p-2" style={{border:"1px solid black",marginTop:"20px",height:"350px",marginLeft:"-15px",width:"450px"}}>
                            ...
                            <div style={{width:"500px"}}><img src={Quetta} style={{width:"400px",marginLeft:"15px",height:"270px"}}/></div>
                            <div className="mt-4">
                                <h6>AD ID 1234567890 <span style={{float:"right"}}>Report THIS AD</span></h6>
                            </div>
                            <div style={{textAlign:"center",marginTop:"80px",fontWeight:"bold"}}>
