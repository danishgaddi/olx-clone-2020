...
import Washing from "../cardsimg/split.jpg";
...
import karachi3 from "../mapimg/karachi3.jpg";
// import logo from "../../olxlogo/olx.png";
class Washdata extends Component {
    render() {
        return (
            <React.Fragment>
                <Header/>
            <div className="container-fluid mt-5 mb-5">
                <div className="row" >
                    <div className="col-md-7">
                        <div>
                            <img src={Washing} style={{width:"800px"}} />
                        </div>
                        <div className="mt-3 p-4" style={{border:"1px solid black", width:"800px"}}>
                            <h3 className="ml-3 mt-1">Details</h3>
                            <p className="mt-3 para">Make<span>Electronics</span><span>Year</span><span>2029</span></p>
                            ...
                            <p className="">Haier automatic washing machine<br/>Washing machine have solor system<br/>Washing machine is completely fine condition<br/>Only interested person can contact me<span></span></p>
                        </div>
                    </div>
                    <div className="col-md-4" style={{border:"1px solid black",height:"150px",marginLeft:"70px"}}>
                        <div>
                            <h2 className="mt-3">Rs: 55000<span style={{float:"right",fontSize:"30px"}}><ShareTwoToneIcon style={{marginRight:"30px"}}/><FavoriteBorderIcon/></span></h2>
                            <p>Haier automatic wasing machine 2020 good condition</p>
                            <p>Karachi, Sindh, Pakistan<span style={{float:"right"}}>21days ago</span></p>
                        </div>
                        ...
                        <div className="mt-5 p-2" style={{border:"1px solid black",marginTop:"20px",height:"350px",marginLeft:"-15px",width:"450px"}}>
                            ...
                            <div style={{width:"500px"}}><img src={karachi3} style={{width:"400px",marginLeft:"15px",height:"270px"}}/></div>
                            <div className="mt-4">
