...
import Laptop from "../cardsimg/laptop.jpg";
...
import Multan from "../mapimg/multan.jpg";
// import logo from "../../olxlogo/olx.png";
class Laptopdata extends Component {
    render() {
        return (
            <React.Fragment>
                <Header/>
            <div className="container-fluid mt-5 mb-5">
                <div className="row" >
                    <div className="col-md-7">
                        <div>
                            <img src={Laptop} style={{width:"800px"}} />
                        </div>
                        <div className="mt-3 p-4" style={{border:"1px solid black", width:"800px"}}>
                            <h3 className="ml-3 mt-1">Details</h3>
                            <p className="mt-3 para">Make<span>Electronics</span><span>Year</span><span>2020</span></p>
                            ...
                            <p className="">Sony Vaio core i8<br/>Core i8 is excellent condition<br/>core i8 is completely accesories<br/>Laptop hhave 8gb ram and 500gb hard disk <br/>Only interested person can contact me<span></span></p>
                        </div>
                    </div>
                    <div className="col-md-4" style={{border:"1px solid black",height:"150px",marginLeft:"70px"}}>
                        <div>
                            <h2 className="mt-3">Rs: 16000<span style={{float:"right",fontSize:"30px"}}><ShareTwoToneIcon style={{marginRight:"30px"}}/><FavoriteBorderIcon/></span></h2>
                            <p>Sony Vaio 2020 core i8 excellent condition </p>
                            <p>Multan, Punjab, Pakistan<span style={{float:"right"}}>18days ago</span></p>
                        </div>
                        ...
                        <div className="p-2" style={{border:"1px solid black",marginTop:"20px",height:"350px",marginLeft:"-15px",width:"450px"}}>
                            <h4 className="mt-3 mx-2">Posted In</h4>
                            <div style={{width:"500px"}}><img src={Multan} style={{width:"400px",marginLeft:"15px",height:"270px"}}/></div>
                            <div className="mt-4">
